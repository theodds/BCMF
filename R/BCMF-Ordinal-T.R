...
## # Projections GAM
## proj_gam_zeta <- projection_gam(meps_new, out_ordinal$indv_direct)
## proj_gam_delta <- projection_gam(meps_new, out_ordinal$indv_indirect)

## hist(proj_gam_zeta[,1])
## hist(proj_gam_delta[,1])

## # Projections Tree
## proj_tree_zeta <- projection_tree(meps_new, model_y, out_ordinal$indv_direct)
## proj_tree_delta <- projection_tree(meps_new, model_y, out_ordinal$indv_indirect)
